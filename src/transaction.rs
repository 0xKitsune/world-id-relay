...
use ethers::types::{Bytes, Eip1559TransactionRequest, TransactionReceipt, H160};
...
pub async fn fill_and_simulate_eip1559_transaction<M: Middleware>(
    ...
    tracing::info!(l1_state_bridge = ?to, ?tx, "Successfully simulated tx");
